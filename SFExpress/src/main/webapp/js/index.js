$(function () {
    $(window).on("load", function () {
            ...
            if (!isMoving) {
                ...
                $(".friut").each(function (index, element) {
                    ...
                    if (srcTop > _top - winHeight / 2) {
                        $(".floor>li").eq(index).addClass("caur").children("span").show().end().siblings().removeClass("caur").children("span").hide();
                    }
                });
            }
        });
        ...
        $(".floor li").hover(function () {
            ...
            $(this).addClass("caur").children("span").show().end().siblings().children("span").hide();
            //运动过程
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.status > 0) {
                ...
                var intnum = parseInt(num.toString());
